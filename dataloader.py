...
__LOCATIONS_PATH = "resources" + os.path.sep + "locations.csv"
...
# Lee el archivo csv que tiene la lista de locations
#
# return: vector de locations
def locations():
    return pd.read_csv(__LOCATIONS_PATH, sep=";")
